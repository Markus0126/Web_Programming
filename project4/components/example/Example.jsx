    ...
    return (
      <div className="container Example">
        ...
        <div className="motto-update">
          <p className="exampleMottoTitle">{this.state.name}</p>
          <p className="exampleMottoImage" >
            <input type="image" src ="images/begging.jpg" alt ="accept" width="75" height="100"></input>
          </p>
          <p className="exampleMotto"> &ldquo; {this.state.motto} &rdquo; </p>
          {/* Your problem #1 motto displaying and updating widget goes here */}
        </div>

        <p className="mottoInput">
          <label htmlFor="idx1">Change Motto:</label>
          <input 
            id="idx1"
            type="text"
